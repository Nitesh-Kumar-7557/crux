...
const ArgumentProbability = ({argumentHeaderData}:{argumentHeaderData: ArgumentHeaderProps}) => {
  return (
    <div className="w-full h-12 bg-surface-container-low relative flex items-center mb-12 border border-outline-variant/20 overflow-hidden">
      <div className="h-full bg-primary flex items-center justify-start px-6 transition-all duration-700 relative overflow-hidden" style={{width: `${argumentHeaderData.affirmativeProbability}%`}}>
