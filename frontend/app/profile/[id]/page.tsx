...
const page = async ({ params }: { params: { id: string } }) => {
  ...
  return (
    <div className="px-8 py-6">
      <UserHeadInfo name={data.userHeadInfo.name} level={data.userHeadInfo.level} description={data.userHeadInfo.description} reputation={data.userHeadInfo.reputation} globalRank={data.userHeadInfo.globalRank}/>
